Rails.application.routes.draw do
  ...
  get   'company_registration/input_user_email',  to: 'company_registration#input_user_email',  as: :input_user_email
  post  'company_registration/input_user_email',  to: 'company_registration#search_user',       as: :search_user
